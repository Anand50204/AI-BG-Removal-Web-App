...
const Upload = () => {
  return (
    <div className=' pb-16 xl:pb-10'>
      <h1 className=' mb-12 sm:mb-20 xl:mb-6 text-center text-2xl md:text-3xl lg:text-4xl mt-4 font-semibold bg-gradient-to-r from-gray-900 to-gray-400 bg-clip-text text-transparent py-5 md:py-16'>See the magic. Try now</h1>
